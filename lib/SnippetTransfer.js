function failure() {
  return { ok: false, error: { code: "INVALID_TRANSFER", message: "Transfer request was invalid" } }
}
...
function toastCommand(code) {
  ...
  else if (code === "SPAWN_FAILED" || code === "TRANSFER_FAILED") message = "Unable to transfer snippet"
  else return null
